...
function __PRIVATE_fromWatchChange(e, t) {
	...
	if ("targetChange" in t) {
		...
		n = new __PRIVATE_WatchTargetChange(r, i, s, o && function __PRIVATE_fromRpcStatus(e$1) {
			return new FirestoreError(void 0 === e$1.code ? C.UNKNOWN : __PRIVATE_mapCodeFromRpcCode(e$1.code), e$1.message || "");
		}(o) || null);
	...
	Di(e, t) {
		...
		return n.H().next(((e$1) => {
			...
			return e$1.forEach(((e$2) => {
				...
				const s = new User(n$2), o = __PRIVATE_IndexedDbDocumentOverlayCache.wt(this.serializer, s), _ = i.getIndexManager(s);
				return new LocalDocumentsView(r, __PRIVATE_IndexedDbMutationQueue.wt(s, this.serializer, _, i.referenceDelegate), o, _).recalculateAndSaveOverlaysForDocumentKeys(new __PRIVATE_IndexedDbTransaction(t, __PRIVATE_ListenSequence.ce), e$2).next();
			}));
		}));
	}
};
...
*/ async function __PRIVATE_syncEngineRejectListen(e, t, n) {
	...
	if (s) {
		...
		await __PRIVATE_syncEngineApplyRemoteEvent(r, new RemoteEvent(SnapshotVersion.min(), /* @__PURE__ */ new Map(), new SortedMap(__PRIVATE_primitiveComparator), e$1, n$1)), r.Ru = r.Ru.remove(s), r.Au.delete(t), __PRIVATE_pumpEnqueuedLimboResolutions(r);
	...
	for (const e$1 of t) {
		...
		if (n$1 && 0 !== n$1.length) {
			...
			for (const e$2 of n$1) {
				const n$2 = await __PRIVATE_synchronizeViewAndComputeSnapshot(r, r.Tu.get(e$2));
...
var __PRIVATE_ArrayUnionFieldValueImpl = class __PRIVATE_ArrayUnionFieldValueImpl extends FieldValue {
	...
	_toFieldTransform(e) {
		const t = __PRIVATE_createSentinelChildContext(this, e, !0), r = new __PRIVATE_ArrayUnionTransformOperation(this.Ac.map(((e$1) => __PRIVATE_parseData(e$1, t))));
...
var __PRIVATE_ArrayRemoveFieldValueImpl = class __PRIVATE_ArrayRemoveFieldValueImpl extends FieldValue {
	...
	_toFieldTransform(e) {
		const t = __PRIVATE_createSentinelChildContext(this, e, !0), r = new __PRIVATE_ArrayRemoveTransformOperation(this.Ac.map(((e$1) => __PRIVATE_parseData(e$1, t))));
		return new FieldTransform(e.path, r);
	}
	isEqual(e) {
...
*/ function getAggregateFromServer(t, e) {
	...
	return __PRIVATE_firestoreClientRunAggregateQuery(r, t._query, s).then(((e$1) => function __PRIVATE_convertToAggregateQuerySnapshot(t$1, e$2, n$1) {
		return new AggregateQuerySnapshot(e$2, new __PRIVATE_ExpUserDataWriter(t$1), n$1);
	}(n, t, e$1)));
}
...
*/ function runTransaction(t, e, n) {
	...
	return __PRIVATE_firestoreClientTransaction(ensureFirestoreConfigured(t), ((n$1) => e(new Transaction(t, n$1))), r);
}
/**
* @license
* Copyright 2020 Google LLC
	...
	if ("DocumentSnapshot" === s.bundleSource) {
		...
		return function __PRIVATE_onSnapshotDocumentSnapshotBundle(t$2, e$1, n$1, r$1, s$1) {
			...
			return loadBundle(t$2, e$1.bundle).then((() => {
				if (!o$1) a$1 = onSnapshot(new DocumentReference(t$2, s$1 || null, DocumentKey.fromPath(e$1.bundleName)), n$1 || {}, r$1);
			})).catch(((t$3) => (r$1.error && r$1.error(t$3), () => {}))), () => {
				o$1 || (o$1 = !0, a$1 && a$1());
			};
		}(r, s, a, t$1, n[o]);
...
*/ function setIndexConfiguration(t, e) {
	...
	return __PRIVATE_firestoreClientSetIndexConfiguration(n, function __PRIVATE_parseIndexes(t$1) {
		...
		if (Array.isArray(e$1.indexes)) for (const t$2 of e$1.indexes) {
			const e$2 = __PRIVATE_tryGetString(t$2, "collectionGroup"), r = [];
			if (Array.isArray(t$2.fields)) for (const e$3 of t$2.fields) {
				const n$2 = __PRIVATE_fieldPathFromDotSeparatedString("setIndexConfiguration", __PRIVATE_tryGetString(e$3, "fieldPath"));
				"CONTAINS" === e$3.arrayConfig ? r.push(new IndexSegment(n$2, 2)) : "ASCENDING" === e$3.order ? r.push(new IndexSegment(n$2, 0)) : "DESCENDING" === e$3.order && r.push(new IndexSegment(n$2, 1));
			}
			n$1.push(new FieldIndex(FieldIndex.UNKNOWN_ID, e$2, r, IndexState.empty()));
		}
		return n$1;
	}(e));
}
...
*/ function deleteAllPersistentCacheIndexes(t) {
	__PRIVATE_firestoreClientDeleteAllFieldIndexes(ensureFirestoreConfigured(t._firestore)).then(((t$1) => __PRIVATE_logDebug("deleting all persistent cache indexes succeeded"))).catch(((t$1) => __PRIVATE_logWarn("deleting all persistent cache indexes failed", t$1)));
}
function __PRIVATE_setPersistentCacheIndexAutoCreationEnabled(t, e) {
	__PRIVATE_firestoreClientSetPersistentCacheIndexAutoCreationEnabled(ensureFirestoreConfigured(t._firestore), e).then(((t$1) => __PRIVATE_logDebug(`setting persistent cache index auto creation isEnabled=${e} succeeded`))).catch(((t$1) => __PRIVATE_logWarn(`setting persistent cache index auto creation isEnabled=${e} failed`, t$1)));
}
/**
